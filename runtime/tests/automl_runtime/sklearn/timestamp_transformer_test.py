...
class TestTimestampTransformer(unittest.TestCase):
    ...
    def setUp(self) -> None:
        ...
        self.timestamp_str_expected = np.array([
            [1.0, 1593566625, False, 0.9659258262890683, -0.25881904510252063,
             0.20956351245274862, 0.9777950369318034, -0.0007152988127704499,
             -0.9999997441737715, 0.25881904510252074, 0.9659258262890683, False, False, 0],
            [1.0, 1593653025, False, 0.39989202431974136, -0.916562255869976,
             0.4021024289259159, 0.9155946901614702, -0.01788151877495909,
             -0.9998401128612018, 0.25881904510252074, 0.9659258262890683, False, False, 1],
            [1.0, 1593739425, False, -0.4672686282730616, -0.88411539350461,
             0.578179224713827, 0.8159097891981183, -0.0350424689714891,
             -0.9993858240781597, 0.25881904510252074, 0.9659258262890683, True, False, 2],
            [1.0, 1593825825, True, -0.9825664732332883, -0.18591160716291416,
             0.7305852951087796, 0.6828214455996658, -0.05219309199157016,
             -0.9986370117056345, 0.25881904510252074, 0.9659258262890683, True, False, 3],
        ])
