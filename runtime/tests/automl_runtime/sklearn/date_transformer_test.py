...
class TestDateTransformer(unittest.TestCase):
    ...
    def setUp(self) -> None:
        ...
        self.X = pd.concat([
            ...
            pd.Series(range(num_rows),
                      name="date1").apply(lambda i: f"2020-07-0{i+1}")
        ],
                           axis=1)
        self.date_expected = np.array([
            [
                1593561600, False, 0.9749279121818236, -0.22252093395631434,
                0.20129852008866006, 0.9795299412524945,
                1.2246467991473532e-16, -1.0, False, False
            ],
            [
    ...
    def test_transform(self):
        ...
        np.testing.assert_array_almost_equal(
            date_transformed.to_numpy(),
            self.date_expected,
            decimal=5,
            err_msg=
            f"Actual: {date_transformed}\nExpected: {self.date_expected}\n"
